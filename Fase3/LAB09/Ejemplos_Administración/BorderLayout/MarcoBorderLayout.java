...
public class MarcoBorderLayout extends JFrame implements ActionListener
{
 ...
 private static final String nombres[] = {"Cambiar a rojo Norte", "Cambiar a rojo Sur",
     "Cambiar a rojo Este", "Cambiar a rojo Oeste", "Cambiar a rojo Centro"};
 private final BorderLayout esquema;

 // establece la GUI y el manejo de eventos
 public MarcoBorderLayout()
 {
     super("Lazo - Calle - Demostración de BorderLayout");
 ...
 public void actionPerformed(ActionEvent evento)
 {
     ...
     for (JButton boton : botones)
     {
    	 if (evento.getSource() == boton) {
             boton.setBackground(Color.RED); // cambia a rojo el oprimido
         	 boton.setText("En rojo");
    	 } 
    	 else {
             boton.setBackground(null); // restaura el color por defecto
    	 }
     }
